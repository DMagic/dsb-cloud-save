...
function _dlbar_checkHideMiniPopup() {
  ...
  // This is called from onDOMNodeRemoved from the mini mode, it
  // executes before the element is actually gone, so check if
  // there is 1 left

  d("dlbar_checkHideMiniPopup");
