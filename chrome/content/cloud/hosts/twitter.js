    ...
    var data = xhr.responseText || '';
      ...
      xhr.onload = function(){
        console.log(xhr.responseText);
	      ...
	      console.log(parsedTokenPairs);
	      cloudSavePreference.setItem('twitter_token', parsedTokenPairs.oauth_token);
	      cloudSavePreference.setItem('twitter_secret', parsedTokenPairs.oauth_token_secret);
	      cloudSavePreference.setItem('twitter_username', parsedTokenPairs.screen_name);
	      callback();
      }
      xhr.send()
	  }
